...
const FILTERS = [
  ...
  { group: "tag", tag: "STAR1ST", stock: true, go: "★ Favorite", how: "Don’t pin. One paste, then star. Or tap GO’s chips.", q: "4*,shiny,lucky,legendary,mythical,ultrabeast,costume,background,@special,fusion,buddy4" },
  { group: "tag", tag: "NUNDO", stock: true, go: "★ Favorite", how: "Don’t pin. Only if you collect nundos.", q: "0attack&0defense&0hp" },
  { group: "tag", tag: "INVEST", stock: true, go: "★ Favorite", how: "Don’t pin. Already-invested combat pieces.", q: "dynamax,gigantamax,mega1,mega2,mega3,shadow&@frustration,adventureeffect,fusion" },
  ...
  { group: "tag", tag: "GL1500", pin: true, go: "Tag PVP", how: "Untagged Great League core. Do not power past 1,500. Meta rotates — confirm on PvPoke.", q: "+azumarill,+medicham,+swampert,+whiscash,+altaria,+skarmory,+lanturn,+clodsire,+jellicent,+empoleon,+tinkaton,+lickitung,+forretress,+mimikyu,+corviknight&!#&cp-1500&0-1attack&3-4defense&3-4hp" },
  ...
  { group: "tag", tag: "LILCUP", stock: true, go: "Tag PVP", how: "Don’t pin. Little Cup candidates under 500 CP with bulk IVs. Warning: evolve = enough candy right now, not ‘species can evolve.’ Skip if you lack candy.", q: "cp-500&0-1attack&3-4defense&3-4hp&evolve" },
